...
https://data-commons-scotland.github.io/regional-dashboards/#/stirling-bin-collection[Stirling bin collection page]
on our website mockup.

image:Stirling-bin-collection-mockup-page-v3.png["The Stirling bin collection page on our website mockup", width="95%", link="https://data-commons-scotland.github.io/regional-dashboards/#/stirling-bin-collection"]
