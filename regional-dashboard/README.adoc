...
The prototype is a webapp and it can be accessed https://data-commons-scotland.github.io/regional-dashboards/[*here*].

image:the-dashboard.png["our prototype regional dashboard", width="95%", link="https://data-commons-scotland.github.io/regional-dashboards/"]
...
The graphs for Fife business waste that there was an acute [green]#reduction#
...
[teal]#_...What underlies that difference in Angus' waste processing?#
