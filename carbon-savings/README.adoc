...
:keywords: waste, reuse, recycle, carbon impact, carbon saving, CO2e, carbon metric, \
3rd sector, Scottish, Scotland, \
linked data, open data, CSVW, RDF, \
Swirrl, Vega, Clojure
...
Let's take a look at two of its graphs 
to see the kind of data-backed stories about carbon savings,
that can be told. 
...
[frame=none,grid=none,cols="1,1"]
|===
a|image:img/usage-placeholder-fairshare.png["A placeholder graph (The Fair Share) for how the carbon savings information can be used"]
a|Each book, plate, duvet, etc. reused through 
...
*This small store has enabled an impressive amount of carbon savings.*
...
|===
a|.The amounts of CO2e that has been avoided in terms of flights. The total CO2e (in terms of flights) of the items of furniture sold (Mar 2017-Aug 2019) in each category.
image:img/usage-placeholder-ace.png["A placeholder graph (ACE )for how the carbon savings information can be used"]
...
In <<m-data-ace>> we 
described how to estimate the CO~2~e values for ACE by multipling the total weight of the items in each category furniture by an appropriate multiplier. These multipliers can be found in our The Scottish Carbon Metric multiplier table. Also, we have to map ACE's item categories to records in that table, and this is done via this mapping table.
...
*The ACE furniture reuse initiative has been running since 1984(!), 
helping prevent furniture from becoming waste.*
|===
