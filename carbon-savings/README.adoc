...
TODO: an example that is based on larger samples of our datasets.
...
|===
a|.The amounts of CO2e that has been avoided in terms of cars
image:img/usage-placeholder-fairshare.png["A placeholder graph (The Fair Share) for how the carbon savings information can be used"]
a|.The amounts of CO2e that has been avoided in terms of flights
